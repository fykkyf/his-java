...
public interface ClinicOrderMapper {
    @Insert("insert into clinic_order values (null,#{visitorId},#{doctorId},#{treatment.treatmentId},#{treatment.treatmentName},#{administrationId},#{dosageId},#{treatmentCount},now(),null)")
