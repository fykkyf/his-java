...
public interface PatientLabMapper {
    ...
    @Insert("insert into patient_lab values (null,#{patientId},#{treatmentId},null,null,1)")
    void insertPatientLab(@Param("patientId") Integer patientId, @Param("treatmentId")Integer treatmentId);
}
